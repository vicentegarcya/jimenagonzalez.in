        ...
        <div className={styles.top}>
          <div className={styles.left}>
            <p>
              ...
              <p style={{ marginTop: "25px", fontSize: "1vw" }}>
                web x{" "}
          ...
          <div className={styles.right}>
            <p>
              <span>Sinergia creativa</span> como forma de trabajo.<br></br>1+1 = ထ viviendo
              la emergencia en la <span>colaboración</span>.
              <br></br>
              <br></br>
              <span>Estrategia</span> como acción inspirada.
              <br></br>
              Alineando <span>visión y esencia</span> con acción real.
            </p>
          </div>
        </div>
