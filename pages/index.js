          ...
          <div className={styles.servicio + " " + styles.regala_sesion}>
            ...
            <div className={styles.servicios_grupo + ' ' + styles.faq}>
              <Service
                ...
                description=<>Despertar Creativo® es el nombre de mi metodología, que combina elementos de estrategia de negocios, procesos creativos y de diseño y espiritualidad, facilitando la conexión con la inspiración auténtica y la acción alineada.{<><br></br><br></br></>}También es el nombre de mi Newsletter mensual, que contiene ejercicios gratuitos, el clima energético del mes,técnicas creativas, recomendaciones, pre-lanzamientos y promociones, meditaciones y mucho más.</>
              />
              <Service
                title="¿Cómo funcionan las sesiones?"
                description=<>Al adquirir la sesión, eliges el día y la hora que mejor te venga para nuestro encuentro. Inmediatamente después recibirás un evento en tu correo electrónico con los detalles de la videollamada.{<><br></br><br></br></>}Previo a la sesión, recibirás un ejercicio de Despertar Creativo®, diseñado para guiarte en una reflexión intuitiva sobre la temática de la sesión. Esta propuesta es completamente opcional, pero suele permitir una mayor profundización y foco en la sesión.{<><br></br><br></br></>}En la sesión en directo, después de una pequeña presentación, enmarcaremos la temática y nos sumergiremos en el tema para alcanzar mayor perspectiva y claridad. Mientras, podrás hacer cualquier pregunta.</>
              />
              <Service
                title="¿Cómo es una sesión conmigo?"
                description=<>Sea la sesión que sea, mi compromiso es sensibilidad, honestidad y excelencia. Sensibilidad, como empatía, alta percepción y escucha; honestidad, como transparencia absoluta; y excelencia, como máxima calidad y entrega de valor en toda la experiencia.</>
              />
              <Service
                title="¿Cómo funcionan los bonos regalo?"
                description=<>Al comprar un bono regalo, recibirás en tu correo electrónico (en el día laboral siguiente), una tarjeta regalo digital personalizada con el nombre de la persona a la que regales.{<><br></br><br></br></>}Con ella, podrá agendar directamente su sesión. Al hacerlo, recibirá un correo electrónico para elegir el tema de su sesión, enviarme los datos necesarios (en caso de que la sesión tenga astrología) y recibir el ejercicio de Despertar Creativo®.</>
              />
              <Service
                title="Tengo un negocio, ¿cómo me puedes ayudar?"
                description=<>Tras más de 8 años de experiencia en consultoría estratégica para grandes empresas y más de 5 de asesoramiento de start-ups, mi especialidad es la estrategia: definición e iteración de modelo de negocio, cartera de productos y servicios, conceptualización de marca, planes estratégicos y tácticos y diseño de experiencia de cliente; así como investigación de mercado y de usuarios.{<><br></br><br></br></>}Además, mi metodología de Despertar Creativo incluye facilitación espiritual, para que la estrategia de tu negocio esté alineada con tu misión personal.{<><br></br><br></br></>}Si no tienes claro si te puedo ayudar o quieres un servicio personalizado {<a href="mailto:jimenagonzalez.in@gmail.com">¡escríbeme</a>} y vemos si somos match!</>
              />
              <Service
                title="Estoy emprendiendo, ¿cómo me puedes ayudar?"
                description=<>Tras 8 años de experiencia en proyectos de innovación e intraemprendimiento y 5 de asesoramiento estratégico de start-ups, además del lanzamiento de mi propio negocio, mi especialidad son las metodologías ágiles para emprender: lean start-up, diseño de negocios y diseño estratégico. Mi expertise abarca la definición del modelo de negocio, la conceptualización de identidad, el plan estratégico y táctico y el diseño de productos y servicios; así como la investigación de mercado y usuarios.{<><br></br><br></br></>}Con mi metodología Despertar Creativo®, incorporo facilitación espiritual  para dotar a tu negocio de alma y alinearlo con tu misión personal.{<><br></br><br></br></>}Si no tienes clara todavía tu necesidad, no sabes si te puedo ayudar o quieres un servicio personalizado, {<a href="mailto:jimenagonzalez.in@gmail.com">¡escríbeme</a>} y vemos si somos match!</>
              />
              <Service
                title="Soy artista o creativ@, ¿cómo me puedes ayudar?"
                description=<>Después de más de 5 años haciendo facilitación creativa en procesos de diseño en equipos de grandes empresas, artistas emergentes y emprendedor@s, me he especializado en metodologías para impulsar el proceso creativo, facilitando procesos individuales o de equipo. {<><br></br><br></br></>}Mi metodología (Despertar Creativo®) está basada en los cuatro ejes divergencia-convergencia, interno-externo; cimentada en conceptos de metodologías de diseño, técnicas creativas y facilitación espiritual, para alinear tus creaciones con tu misión personal y tu auténtica esencia.{<><br></br><br></br></>}Si tienes dudas, no sabes si te puedo ayudar o quieres un servicio personalizado, {<a href="mailto:jimenagonzalez.in@gmail.com">¡escríbeme</a>} y vemos si somos match!</>
              />
              <Service
                title="Estoy en mi camino de evolución personal, ¿cómo me puedes ayudar?"
                description=<>Tras mi propio camino de sanación y evolución personal que comenzó hace más de 10 años, hace 3 experimenté el mayor proceso de despertar espiritual hasta la fecha. Entonces comencé a hacer sesiones de Tarot y astrología a otras personas; y desde entonces he acompañado a más de 150.{<><br></br><br></br></>}Aunque mi camino espiritual y de aprendizaje está en constante evolución, y voy aprendiendo más de otras herramientas, como numerología, diseño humano o registros akásicos, el core de mi oferta es Tarot y astrología, que uso con un enfoque evolutivo-espiritual.{<><br></br><br></br></>}Es decir, mi intención es ampliar tu perspectiva, ayudarte a comprender el propósito de tus experiencias y la energía disponible para ti, de modo que puedas tomar acción de manera más consciente y alineada.{<><br></br><br></br></>}Si quieres una sesión diferente a las que tengo disponibles, {<a href="mailto:jimenagonzalez.in@gmail.com">¡escríbeme!</a>}</>
              />
              <Service
                title="Quiero algo distinto"
                description=<>Si tienes alguna otra necesidad o idea (sesiones con tu equipo, formaciones, charlas, acompañamiento a medio plazo), puedes usar la sección “Hazme una propuesta” en la home o {<a href="mailto:jimenagonzalez.in@gmail.com">escribirme</a>} un correo.{<><br></br><br></br></>}Te responderé a la mayor brevedad posible para conversar sobre tu necesidad y pasarte un presupuesto. En caso de no poder ayudarte, quizá pueda recomendarte otr@s profesional@s que sí puedan.</>
              />
            </div>
          </div>
        </section>
